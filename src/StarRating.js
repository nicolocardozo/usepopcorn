...
function StarRating({ maxRating = 5, color = '#fcc419', size = 48, defaultRating = 0, onSetRating }) {
...
function Star({ onRate, full, onHoverIn, onHoverOut, color, size }) {
  ...
  return (
    <span style={star} role="button" onClick={onRate} onMouseEnter={onHoverIn} onMouseLeave={onHoverOut}>
      {full ? (
